...
// build/dist/types.js
var TodoListState;
(function(TodoListState2) {
  TodoListState2[TodoListState2["ALL"] = 0] = "ALL";
  TodoListState2[TodoListState2["ACTIVE"] = 1] = "ACTIVE";
  TodoListState2[TodoListState2["COMPLETED"] = 2] = "COMPLETED";
})(TodoListState || (TodoListState = {}));

// build/dist/utils.js
function filterTodos(todos, todoListState) {
...
// build/dist/pkg/canvas-confetti.js
var module = {};
...
var ulPageElm = document.querySelector("#ul-item");
function updateUi() {
  updateUiTodo();
  updateUiBtn();
}
...
var inputElm = document.querySelector("#todo-text");
...
init();
var canvasElm = document.querySelector("#canvas-confetti");
var myConfetti = canvas_confetti_default.create(canvasElm, {
  resize: true,
  useWorker: true
});
